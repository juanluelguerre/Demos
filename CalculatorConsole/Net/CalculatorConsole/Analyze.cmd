...
SonarQube.Scanner.MSBuild begin /k:"CalculatorConsole" /n:"CalculatorConsole" /v:"1.0" /d:sonar.cs.vscoveragexml.reportsPaths="%CD%\VisualStudio.coveragexml" /d:sonar.cs.msbuild.testProjectPattern="[^\\\\]*test[^\\\\]*$"
